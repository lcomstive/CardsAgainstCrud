...
/**
 * Makes an API call. (Only supports GET.)
 *
 * @param {string} endpoint - The url to make a GET request to.
 * @param {number} [timeout] - A timeout (in ms). Defaults to 2000.
 * @returns {Promise} Returns a promise that resolves to the returned data, or a PaginatedResult.
 */
